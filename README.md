...
* **to:** SHA2'd mobile-number of your partner
...
* **partner:** SHA2'd mobile-number of the public key's owner
* **key:** Base64 encoded publickey

#####"GTM": got text message
**Parameters:**

* **from:** SHA2'd mobile-number of the sender
* **content:** Base64 encoded, NaCl encrypted message
...
* **from:** SHA2'd mobile-number of your partner
